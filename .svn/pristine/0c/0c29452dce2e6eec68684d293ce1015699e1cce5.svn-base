...
/**
 * TbGeologyscene entity. @author MyEclipse Persistence Tools
 */

public class TbGeologyscene implements java.io.Serializable {
	...
	/** default constructor */
	public TbGeologyscene() {
	}

	/** full constructor */
	public TbGeologyscene(TbBasicinfo tbBasicinfo, String pic,
