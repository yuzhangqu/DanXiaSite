...
/**
 * TbGeologyinfo entity. @author MyEclipse Persistence Tools
 */

public class TbGeologyinfo implements java.io.Serializable {
	...
	/** default constructor */
	public TbGeologyinfo() {
	}

	/** minimal constructor */
	public TbGeologyinfo(TbBasicinfo tbBasicinfo) {
		this.tbBasicinfo = tbBasicinfo;
	}

	/** full constructor */
	public TbGeologyinfo(TbBasicinfo tbBasicinfo, String northLatitude,
			String northLongitude, String southLatitude, String southLongitude,
			String eastLatitude, String eastLongitude, String westLatitude,
			String westLongitude, String centerLatitude,
			String centerLongitude, String reliefContinuousArea,
			String redbedContinuousArea, String redbedTotalArea,
			String lowAltitude, String highAltitude, String mediumAltitude,
			String redbedAge, String redbedAgeDescription, String stratumName1,
			String stratumDescription1, String stratumName2,
			String stratumDescription2, String thickName1, String thickness1,
			String thickName2, String thickness2, String offshore1,
			String offshore2, String eolianDeposit,
			String eolianDepositDescription, String conglomerateSize,
			String conglomerateColor, String conglomerateIngredient,
			String conglomerateCement, String conglomerateStructure,
			String conglomerateResistence, String conglomerateFossil,
			String conglomerateAppearance, String conglomeratePickup,
			String sandstoneSize, String sandstoneColor,
			String sandstoneIngredient, String sandstoneCement,
			String sandstoneStructure, String sandstoneResistence,
			String sandstoneFossil, String sandstoneAppearance,
			String sandstonePickup, String siltstoneSize,
			String siltstoneColor, String siltstoneIngredient,
			String siltstoneCement, String siltstoneStructure,
			String siltstoneResistence, String siltstoneFossil,
			String siltstoneAppearance, String siltstonePickup,
			String claySize, String clayColor, String clayIngredient,
			String clayCement, String clayStructure, String clayResistence,
			String clayFossil, String clayAppearance, String clayPickup,
			String structurePosition, String basinName, String basinAge,
			String structureMotion, String structureLine, String crumple,
			String fault, String joint, String structureDescription,
			String reliefUnit, String reliefPosition, String terrain,
			String reliefDescription, String dependentType,
			String dependentAppearance, String dependentForce,
			String slopeType, String slopeRock, String slopeBody,
			String danxiaRavine, String danxiaWall, String danxiaCave,
			String danxiaValt, String dependentShape, String dependentStage,
			String dependentDescription, String cliffMaxHeight,
			String cliffMediumHeight, String cliffMaxGradient,
			String cliffMediumGradient, String slopeShape, String cornerType,
			String slopeDescription, String landmarkScene, String specialScene,
			String reliefStructure, String overallScene) {
		this.tbBasicinfo = tbBasicinfo;
	...
	public String getReliefContinuousArea() {
		return this.reliefContinuousArea;
	}
	...
	public String getRedbedContinuousArea() {
		return this.redbedContinuousArea;
	}
	...
	public String getRedbedAgeDescription() {
		return this.redbedAgeDescription;
	}
	...
	public String getStratumDescription1() {
		return this.stratumDescription1;
	}
	...
	public String getStratumDescription2() {
		return this.stratumDescription2;
	}
	...
	public String getEolianDepositDescription() {
		return this.eolianDepositDescription;
	}
	...
	public String getConglomerateIngredient() {
		return this.conglomerateIngredient;
	}
	...
	public String getConglomerateCement() {
		return this.conglomerateCement;
	}
	...
	public String getConglomerateStructure() {
		return this.conglomerateStructure;
	}
	...
	public String getConglomerateResistence() {
		return this.conglomerateResistence;
	}
	...
	public String getConglomerateFossil() {
		return this.conglomerateFossil;
	}
	...
	public String getConglomerateAppearance() {
		return this.conglomerateAppearance;
	}
	...
	public String getConglomeratePickup() {
		return this.conglomeratePickup;
	}
	...
	public String getSandstoneIngredient() {
		return this.sandstoneIngredient;
	}
	...
	public String getSandstoneStructure() {
		return this.sandstoneStructure;
	}
	...
	public String getSandstoneResistence() {
		return this.sandstoneResistence;
	}
	...
	public String getSandstoneAppearance() {
		return this.sandstoneAppearance;
	}
	...
	public String getSiltstoneIngredient() {
		return this.siltstoneIngredient;
	}
	...
	public String getSiltstoneStructure() {
		return this.siltstoneStructure;
	}
	...
	public String getSiltstoneResistence() {
		return this.siltstoneResistence;
	}
	...
	public String getSiltstoneAppearance() {
		return this.siltstoneAppearance;
	}
	...
	public String getDependentAppearance() {
		return this.dependentAppearance;
	}
	...
	public String getDependentDescription() {
		return this.dependentDescription;
	}
	...
	public String getCliffMediumGradient() {
		return this.cliffMediumGradient;
	}
