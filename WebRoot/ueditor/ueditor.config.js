 ...
 */
/*******************************************************************************
 * 閹绘劗銇�*********************** 閹碉拷婀佺悮顐ｆ暈闁插﹦娈戦柊宥囩枂妞ょ懓娼庢稉绡ditor姒涙顓婚崐绗猴拷
...
(function() {
	 ...
	 * 闁寸繝绨鍫濐檵閸氬苯顒熼崷銊ゅ▏閻劎绱潏鎴濇珤閻ㄥ嫭妞傞崐娆忓毉閻滄壆娈戠粔宥囶瀸鐠侯垰绶為梻顕�暯閿涘本顒濇径鍕繁閻戝牆缂撶拋顔笺亣鐎规湹濞囬悽锟介惄绋款嚠娴滃海缍夌粩娆愮壌閻╊喖缍嶉惃鍕祲鐎电鐭惧锟芥潻娑滎攽闁板秶鐤嗛妴锟�
	 * "閻╃顕禍搴ｇ秹缁旀瑦鐗撮惄顔肩秿閻ㄥ嫮娴夌�纭呯熅瀵帮拷娑旂喎姘ㄩ弰顖欎簰閺傛粍娼锟姐仈閻ㄥ嫬鑸版俊锟�DanXia/ueditor/"鏉╂瑦鐗遍惃鍕熅瀵板嫨锟�
	 * 婵″倹鐏夌粩娆戝仯娑擃厽婀佹径姘嚋娑撳秴婀崥灞肩鐏炲倻楠囬惃鍕�闂堛垽娓剁憰浣哥杽娓氬瀵茬紓鏍帆閸ｎ煉绱濇稉鏂跨穿閻劋绨￠崥灞肩UEditor閻ㄥ嫭妞傞崐娆欑礉濮濄倕顦甸惃鍒凴L閸欘垵鍏樻稉宥夛拷閻劋绨В蹇庨嚋妞ょ敻娼伴惃鍕椽鏉堟垵娅掗妴锟�
	 * 閸ョ姵顒濋敍瀛禘ditor閹绘劒绶垫禍鍡涙嫛鐎甸�绗夐崥宀勩�闂堛垻娈戠紓鏍帆閸ｃ劌褰查崡鏇犲闁板秶鐤嗛惃鍕壌鐠侯垰绶為敍灞藉徔娴ｆ挻娼电拠杈剧礉閸︺劑娓剁憰浣哥杽娓氬瀵茬紓鏍帆閸ｃ劎娈戞い鐢告桨閺堬拷銆婇柈銊ュ晸娑撳﹤顪嗘稉瀣╁敩閻礁宓嗛崣顖橈拷瑜版挾鍔ч敍宀勬付鐟曚椒鎶ゅ銈咁樀閻ㄥ垊RL缁涘绨�鐟扮安閻ㄥ嫰鍘ょ純顔猴拷
	...
	window.UEDITOR_CONFIG = {
		...
		// 閸ュ墽澧栨稉濠佺炊闁板秶鐤嗛崠锟�
		,
		imageUrl : URL + "jsp/imageUp.jsp" // 閸ュ墽澧栨稉濠佺炊閹绘劒姘﹂崷鏉挎絻
		,
		imagePath : URL + "jsp/" // 閸ュ墽澧栨穱顔筋劀閸︽澘娼冮敍灞界穿閻劋绨ixedImagePath,婵″倹婀侀悧瑙勭暕闂囷拷鐪伴敍灞藉讲閼奉亣顢戦柊宥囩枂
		// ,imageFieldName:"upfile"
		// //閸ュ墽澧栭弫鐗堝祦閻ㄥ埍ey,閼汇儲顒濇径鍕叏閺�櫢绱濋棁锟筋渽閸︺劌鎮楅崣鏉款嚠鎼存梹鏋冩禒鏈垫叏閺�懓顕惔鏂垮棘閺侊拷
		// ,compressSide:0
		// //缁涘鐦崢瀣級閻ㄥ嫬鐔�崙鍡礉绾喖鐣緈axImageSideLength閸欏倹鏆熼惃鍕棘閻撗冾嚠鐠灺帮拷0娑撶儤瀵滈悡褎娓堕梹鑳珶閿涳拷娑撶儤瀵滈悡褍顔旀惔锔肩礉2娑撶儤瀵滈悡褔鐝惔锟�
		// ,maxImageSideLength:900
		// //娑撳﹣绱堕崶鍓у閺堬拷銇囬崗浣筋啅閻ㄥ嫯绔熼梹鍖＄礉鐡掑懓绻冩导姘冲殰閸斻劎鐡戝В鏃傜級閺�拷娑撳秶缂夐弨鎯ф皑鐠佸墽鐤嗘稉锟介嚋濮ｆ棁绶濇径褏娈戦崐纭风礉閺囨潙顧嬬拋鍓х枂閸︹暐mage.html娑擄拷

		// 濞戝倿鐢崶鍓у闁板秶鐤嗛崠锟�
		,
		scrawlUrl : URL + "jsp/scrawlUp.jsp" // 濞戝倿鐢稉濠佺炊閸︽澘娼�
		,
		scrawlPath : URL + "jsp/" // 閸ュ墽澧栨穱顔筋劀閸︽澘娼冮敍灞芥倱imagePath

		// 闂勫嫪娆㈡稉濠佺炊闁板秶鐤嗛崠锟�
		,
		fileUrl : URL + "jsp/fileUp.jsp" // 闂勫嫪娆㈡稉濠佺炊閹绘劒姘﹂崷鏉挎絻
		,
		filePath : URL + "jsp/" // 闂勫嫪娆㈡穱顔筋劀閸︽澘娼冮敍灞芥倱imagePath
		// ,fileFieldName:"upfile"
		// //闂勫嫪娆㈤幓鎰唉閻ㄥ嫯銆冮崡鏇炴倳閿涘矁瀚㈠銈咁樀娣囶喗鏁奸敍宀勬付鐟曚礁婀崥搴″酱鐎电懓绨查弬鍥︽娣囶喗鏁肩�鐟扮安閸欏倹鏆�

		// 鏉╂粎鈻奸幎鎾冲絿闁板秶鐤嗛崠锟�
		// ,catchRemoteImageEnable:true //閺勵垰鎯佸锟芥儙鏉╂粎鈻奸崶鍓у閹舵挸褰�姒涙顓诲锟芥儙
		,
		catcherUrl : URL + "jsp/getRemoteImage.jsp" // 婢跺嫮鎮婃潻婊呪柤閸ュ墽澧栭幎鎾冲絿閻ㄥ嫬婀撮崸锟�
		,
		catcherPath : URL + "jsp/" // 閸ュ墽澧栨穱顔筋劀閸︽澘娼冮敍灞芥倱imagePath
		// ,catchFieldName:"upfile"
		// //閹绘劒姘﹂崚鏉挎倵閸欐媽绻欑粙瀣禈閻楀檽ri閸氬牓娉﹂敍宀冨濮濄倕顦垫穱顔芥暭閿涘矂娓剁憰浣告躬閸氬骸褰寸�鐟扮安閺傚洣娆㈡穱顔芥暭鐎电懓绨查崣鍌涙殶
		// ,separater:'ue_separate_ue' //閹绘劒姘﹂懛鍐叉倵閸欐壆娈戞潻婊呪柤閸ュ墽澧栭崷鏉挎絻鐎涙顑佹稉鎻掑瀻闂呮梻顑�
		// ,localDomain:[]
		// //閺堫剙婀存い鍓侀獓閸╃喎鎮曢敍灞界秼瀵拷鎯庢潻婊呪柤閸ュ墽澧栭幎鎾冲絿閺冭绱濋梽銈嗩劃娑斿顧囬惃鍕閺堝鍙剧�鍐ㄧ厵閸氬秳绗呴惃鍕禈閻楀洭鍏樼亸鍡氼枂閹舵挸褰囬崚鐗堟拱閸︼拷姒涙顓绘稉宥嗗閸欙拷27.0.0.1閸滃ocalhost

		// 閸ュ墽澧栭崷銊у殠缁狅紕鎮婇柊宥囩枂閸栵拷
		,
		imageManagerUrl : URL + "jsp/imageManager.jsp" // 閸ュ墽澧栭崷銊у殠缁狅紕鎮婇惃鍕樀閻炲棗婀撮崸锟�
		,
		imageManagerPath : URL + "jsp/" // 閸ュ墽澧栨穱顔筋劀閸︽澘娼冮敍灞芥倱imagePath

		// 鐏炲繐绠烽幋顏勬禈闁板秶鐤嗛崠锟�
		,
		snapscreenHost : location.hostname // 鐏炲繐绠烽幋顏勬禈閻ㄥ墕erver缁旑垱鏋冩禒鑸靛閸︺劎娈戠純鎴犵彲閸︽澘娼冮幋鏍拷ip閿涘矁顕稉宥堫渽閸旂垉ttp://
		,
		snapscreenServerUrl : URL + "jsp/imageUp.jsp" // 鐏炲繐绠烽幋顏勬禈閻ㄥ墕erver缁旑垯绻氱�妯尖柤鎼村骏绱漊Editor閻ㄥ嫯瀵栨笟瀣╁敩閻椒璐熼垾娣疪L
		// +"server/upload/jsp/snapImgUp.jsp"閳ワ拷
		,
		snapscreenPath : URL + "jsp/",
		snapscreenServerPort : location.port // 鐏炲繐绠烽幋顏勬禈閻ㄥ墕erver缁旑垳顏崣锟�
		// ,snapscreenImgAlign: '' //閹搭亜娴橀惃鍕禈閻楀洭绮拋銈囨畱閹烘帞澧楅弬鐟扮础

		// word鏉烆剙鐡ㄩ柊宥囩枂閸栵拷
		,
		wordImageUrl : URL + "jsp/imageUp.jsp" // word鏉烆剙鐡ㄩ幓鎰唉閸︽澘娼�
		,
		wordImagePath : URL + "jsp/" //
		// ,wordImageFieldName:"upfile"
		// //word鏉烆剙鐡ㄧ悰銊ュ礋閸氬秷瀚㈠銈咁樀娣囶喗鏁奸敍宀勬付鐟曚礁婀崥搴″酱鐎电懓绨查弬鍥︽娣囶喗鏁肩�鐟扮安閸欏倹鏆�

		// 閼惧嘲褰囩憴鍡涱暥閺佺増宓侀惃鍕勾閸э拷
		,
		getMovieUrl : URL + "jsp/getMovie.jsp" // 鐟欏棝顣堕弫鐗堝祦閼惧嘲褰囬崷鏉挎絻
	...
	// }
	// webAppKey
	// 閻ф儳瀹虫惔鏃傛暏閻ㄥ嚈PIkey閿涘本鐦℃稉顏嗙彲闂�灝绻�い濠氼湚閸忓牆骞撻惂鎯у鐎规缍夊▔銊ュ斀娑擄拷閲渒ey閸氬孩鏌熼懗鑺ヮ劀鐢晲濞囬悽鈺漰p閸旂喕鍏�
	// ,webAppKey:""
	...
	// lang閸婇棿绡冮崣顖欎簰闁俺绻冮懛顏勫З閼惧嘲褰�(navigator.language||navigator.browserLanguage
	...
	// ,initialContent:'濞嗐垼绻嬫担璺ㄦ暏ueditor!'
	// //閸掓繂顬婇崠鏍椽鏉堟垵娅掗惃鍕敶鐎癸拷娑旂喎褰叉禒銉╋拷鏉╁檼extarea/script缂佹瑥锟介敍宀�箙鐎规缍夋笟瀣摍

	// ,initialFrameWidth:1000 //閸掓繂顬婇崠鏍椽鏉堟垵娅掔�钘夊,姒涙顓�000
	// ,initialFrameHeight:320 //閸掓繂顬婇崠鏍椽鏉堟垵娅掓妯哄,姒涙顓�20

	// ,autoClearinitialContent:true
	// //閺勵垰鎯侀懛顏勫З濞撳懘娅庣紓鏍帆閸ｃ劌鍨垫慨瀣敶鐎圭櫢绱濆▔銊﹀壈閿涙艾顪嗛弸娓噊cus鐏炵偞锟界拋鍓х枂娑撶皪rue,鏉╂瑤閲滄稊鐔惰礋閻噦绱濋柇锝勭疄缂傛牞绶崳銊ょ娑撳﹥娼电亸鍙樼窗鐟欙箑褰傜�鑹板毀閸掓繂顬婇崠鏍畱閸愬懎顔愰惇瀣╃瑝閸掗绨�

	// ,iframeCssUrl: URL + '/themes/iframe.css' //缂佹瑧绱潏鎴濇珤閸愬懘鍎村鏇炲弳娑擄拷閲渃ss閺傚洣娆�

	// ,textarea:'editorValue' //
	// 閹绘劒姘︾悰銊ュ礋閺冭绱濋張宥呭閸ｃ劏骞忛崣鏍椽鏉堟垵娅掗幓鎰唉閸愬懎顔愰惃鍕閻劎娈戦崣鍌涙殶閿涘苯顧嬬�鐐扮伐閺冭泛褰叉禒銉х舶鐎圭懓娅抧ame鐏炵偞锟介敍灞肩窗鐏忓攳ame缂佹瑥鐣鹃惃鍕拷閺堬拷璐熷В蹇庨嚋鐎圭偘绶ラ惃鍕暛閸婄》绱濇稉宥囨暏濮ｅ繑顐肩�鐐扮伐閸栨牜娈戦弮璺猴拷闁�顔曠純顔跨箹娑擃亜锟�

	// ,focus:false //閸掓繂顬婇崠鏍ㄦ閿涘本妲搁崥锕侇唨缂傛牞绶崳銊ㄥ箯瀵版鍔嶉悙绠價ue閹存潊alse

	// ,autoClearEmptyNode : true
	// //getContent閺冭绱濋弰顖氭儊閸掔娀娅庣粚铏规畱inlineElement閼哄倻鍋ｉ敍鍫濆瘶閹奉剙绁垫總妤冩畱閹懎鍠岄敍锟�
	...
	// //閺勵垰鎯佸锟芥儙鐞涖劍鍎忛張顒�勾閸栨牭绱濇妯款吇閸忔娊妫撮妴鍌濆鐟曚礁绱戦崥顖濐嚞绾喕绻歟motion閺傚洣娆㈡径閫涚瑓閸栧懎鎯堢�妯肩秹閹绘劒绶甸惃鍒琺ages鐞涖劍鍎忛弬鍥︽婢讹拷

	// ,pasteplain:false //閺勵垰鎯佹妯款吇娑撹櫣鍑介弬鍥ㄦ拱缁鍒涢妴淇lse娑撹桨绗夋担璺ㄦ暏缁绢垱鏋冮張顒傜煒鐠愯揪绱漷rue娑撹桨濞囬悽銊у嚱閺傚洦婀扮划妯垮垱
	// 缁绢垱鏋冮張顒傜煒鐠愬瓨膩瀵繋绗呴惃鍕箖濠娿倛顬冮崚锟�
	...
	// insertunorderedlist
	// 閺冪姴绨崚妤勩�閻ㄥ嫪绗呴幏澶愬帳缂冾噯绱濋崐鑲╂殌缁岀儤妞傞弨顖涘瘮婢舵俺顕㈢懛锟藉殰閸斻劏鐦戦崚顐礉閼汇儵鍘ょ純顔硷拷閿涘苯鍨禒銉︻劃閸婇棿璐熼崙锟�
	// ,insertunorderedlist : {
	// //閼奉亜鐣鹃惃鍕壉瀵拷
	// 'dash' :'閳ワ拷閻瓨濮岄崣锟�
	// 'dot':' 閵嗭拷鐏忓繐娓鹃崷锟�
	...
	// ,maxListLevel : 3 //闂勬劕鍩楅崣顖欎簰tab閻ㄥ嫮楠囬弫锟�娑撳秹妾洪崚锟�
	// fontfamily
	// 鐎涙ぞ缍嬬拋鍓х枂 label閻ｆ瑧鈹栭弨顖涘瘮婢舵俺顕㈢懛锟藉殰閸斻劌鍨忛幑顤庣礉閼汇儵鍘ょ純顕嗙礉閸掓瑤浜掗柊宥囩枂閸婇棿璐熼崙锟�
	// ,'fontfamily':[
	...
	// 鐏忎粙鍣烘担璺ㄦ暏娑擄拷绨虹敮鍝ユ暏閻ㄥ嫭鐖ｇ粵锟�
	// 閸欏倹鏆熺拠瀛樻
	// tag 娴ｈ法鏁ら惃鍕垼缁涙儳鎮曠�锟�
	// label 閺勫墽銇氶惃鍕倳鐎涙ぞ绡冮弰顖滄暏閺夈儲鐖ｇ拠鍡曠瑝閸氬瞼琚崹瀣畱閺嶅洩鐦戠粭锔肩礉濞夈劍鍓版潻娆庨嚋閸婂吋鐦℃稉顏囶渽娑撳秴鎮撻敍锟�
	// style 濞ｈ濮為惃鍕壉瀵拷
	// 濮ｅ繋绔存稉顏勵嚠鐠炩�姘ㄩ弰顖欑娑擃亣鍤滅�姘疅閻ㄥ嫭鐗卞锟�
	// ,'customstyle':[
	...
	// 鐡掑懎鍤�妤佹殶闂勬劕鍩楅幓鎰仛 閻ｆ瑧鈹栭弨顖涘瘮婢舵俺顕㈢懛锟藉殰閸斻劌鍨忛幑顤庣礉閸氾箑鍨幐澶嬵劃闁板秶鐤嗛弰鍓с仛
	// ,wordOverFlowMsg:'' //<span
	// style="color:red;">娴ｇ姾绶崗銉ф畱鐎涙顑佹稉顏呮殶瀹歌尙绮＄搾鍛毉閺堬拷銇囬崗浣筋啅閸婄》绱濋張宥呭閸ｃ劌褰查懗鎴掔窗閹锋帞绮锋穱婵嗙摠閿涳拷/span>

	// highlightcode
	// 娴狅絿鐖滄妯瑰瘨閺冨爼娓剁憰浣稿鏉炵晫娈戠粭顑跨瑏閺傝褰冩禒鍓佹畱鐠侯垰绶�
	...
	// ,maxUndoCount:20
	// 瑜版捁绶崗銉ф畱鐎涙顑侀弫鎷岀Т鏉╁洩顕氶崐鍏兼閿涘奔绻氱�妯圭濞嗭紕骞囬崷锟�
	// ,maxInputCount:1
	...
	// codeMirrorJsUrl js閸旂姾娴囬惃鍕熅瀵板嫸绱濇妯款吇閺勶拷URL +
	// "third-party/codemirror/codemirror.js"
	// ,codeMirrorJsUrl:URL + "third-party/codemirror/codemirror.js"
	// codeMirrorCssUrl css閸旂姾娴囬惃鍕熅瀵板嫸绱濇妯款吇閺勶拷URL +
	...
	// textAlign : "left" , //濞堜絻鎯ら惃鍕笓閻楀牊鏌熷蹇ョ礉閸欘垯浜掗弰锟絣eft,right,center,justify
	// 閸樼粯甯�潻娆庨嚋鐏炵偞锟界悰銊с仛娑撳秵澧界悰灞惧笓閻楋拷
	// imageBlockLine : 'center', //閸ュ墽澧栭惃鍕癁閸斻劍鏌熷蹇ョ礉閻欘剙宕版稉锟筋攽閸撗傝厬,瀹革箑褰稿ù顔煎З閿涘矂绮拋锟�
	// center,left,right,none 閸樼粯甯�潻娆庨嚋鐏炵偞锟界悰銊с仛娑撳秵澧界悰灞惧笓閻楋拷
