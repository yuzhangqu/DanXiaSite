        ...
        <div class="main">
            <img class="title" src="img/index2.jpg" alt="" />
					...
					<div class="content_pos">
                        ...
                        <form action="saveTitbits"  method="post">
							    ...
							    <script type="text/plain" id="editor" name="myContent" style="width:100%;height:80%;">
   								...
   								<br/>
						    	<button class="button03" onclick="return validate_form()" type="submit">发布</button>
								  <input type="button" class="button03" value="返回" onclick="window.location.href='listTitbits'"/>
						</form>
					</div>
