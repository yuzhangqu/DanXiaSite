			...
			<div class="content_long">
				<div class="content_pos">
					...
					<form class="form-signin" name="firstForm"
						action="searchUpdate" method="post" id="firstForm">
						<div class="controls">
					...
					<form name="secondForm" action="updateInfo" method="post">
						<table width="600" border="1" cellpadding="5" align="center">
							...
							<s:iterator value="info">
								<tr>
									<td height="50"><a href="updateInfo.action?id=<s:property value="basicId"/>">
									<s:property value="nameCurrent"/>
									</td>
