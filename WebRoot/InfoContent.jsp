					...
					<!-- Nav -->
						<nav id="nav">
							<ul style="text-align:center">
								...
								<li><a href="#contact2" id="top-link" class="skel-panels-ignoreHref"><span id="fcontactinfo" class="icon icon-th">调查人员</span></a></li>
								<li><a href="#contact3" id="portfolio-link" class="skel-panels-ignoreHref"><span id="fsave" class="icon icon-th">保护命名</span></a></li>
								<li><a href="#contact4" id="about-link" class="skel-panels-ignoreHref"><span id="fgeneralpic" class="icon icon-th">通用图片</span></a></li>
								<li><a href="#contact5" id="contact-link" class="skel-panels-ignoreHref"><span id="flandmark" class="icon icon-th">标志景观</span></a></li>
								<li><a href="#contact6" id="top-link" class="skel-panels-ignoreHref"><span id="fgeology" class="icon icon-th">地质图片</span></a></li>
								<li><a href="#contact7" id="portfolio-link" class="skel-panels-ignoreHref"><span id="fculture" class="icon icon-th">文化图片</span></a></li>
								<li><a href="#contact8" id="about-link" class="skel-panels-ignoreHref"><span id="finvesgater" class="icon icon-th">审核信息</span></a></li>
								<br/><br/>
								<li><input type="button" class="button03" id="btn_back" onclick="window.location.href='searchInfo.jsp'" /></li>
							</ul>
						</nav>
			...
			<div id="main">
				...
				<!-- 地方文化 -->
					...
					<section id="contact3" class="six">
						<div class="container">
                               <h3 id="fworldnamed"></h3>
								<s:checkboxlist name="worldLevel" list="#request.worldlevels" 
                                     listKey="worldLevelId"
                                     listValue="worldLevelName"
                                     value="#request.wlevels" >
                               </s:checkboxlist>
                               <br /> <br />
                               
                               <h3 id="fcountrynamed"></h3>
								<s:checkboxlist name="countryLevel" list="#request.countrylevels" 
                                             listKey="countryLevelId"
                                             listValue="countryLevelName"
                                             value="#request.clevels" >
                                </s:checkboxlist>
                                <br /> <br />
                                
                                <h3 id="fprovincenamed"></h3>
								<s:checkboxlist name="provinceLevel" list="#request.provincelevels"	         
                                     listKey="provinceLevelId"
                                     listValue="provinceLevelName" 
                                     value="#request.plevels">
                               </s:checkboxlist>
                               <br /> <br />
                               
                               <h3 id="flakenamed"></h3>
								<s:checkboxlist name="lakeLevel" list="#request.lakelevels" 
                                             listKey="lakeLevelId"
                                             listValue="lakeLevelName"
                                             value="#request.llevels" >
                                </s:checkboxlist>
                                <br /> <br />
						</div>
					</section>
					...
					<section id="contact4" class="seven">
						<div class="container">
						<h3 id="fgeneral"></h3>
						<img class="picview" src="${lake1}" />
						        <div class="row half">
							         <div class="2u"><span>图片描述:</span></div>
							         <div class="8u"><input type="text" class="text" value="${lakedes}" placeholder="河湖相沉积地层图片"/></div>
							         
							    </div>
							    <br/><br/>
							<img class="picview" src="${XXstone}" />
							     <div class="row half">
							           <div class="2u"><span>图片描述:</span></div>
							           <div class="8u"><input type="text" class="text" value="${XXstonedes}" placeholder="XX组砾岩层图片"  /></div>
							           </div> 
							           <br/><br/>
						    <img class="picview" src="${XXstonejiaocuo}" /><br/> 
							       <div class="row half">
							           <div class="2u"><span>图片描述:</span></div>
							           <div class="8u"><input type="text" class="text" value="${XXstonejiaocuodes} " placeholder="XX组XX段中粒砂岩及交错层理图片" /></div>
							         </div>
							        <br/><br/>
							  <img class="picview" src="${fensha}" /><br/> 
							          <div class="row half">
							           <div class="2u"><span>图片描述:</span></div>
							           <div class="8u"><input type="text" class="text" value="${fenshades} " placeholder="XX组XX段的粉砂岩夹层图片"/></div>
							           </div>
							           <br/><br/>
							  <img class="picview" src="${nizhi}" /><br/> 
		                               <div class="row half">
							           <div class="2u"><span>图片描述:</span></div>
							           <div class="8u"><input type="text" class="text" value="${nizhides}"  placeholder="XX组XX段中的泥质岩图片"/></div>
                                      </div>
                                      <br/> <br/> 
							  <img class="picview" src="${pendi}" /><br/> 
							          <div class="row half">
							           <div class="2u"><span>图片描述:</span></div>
							           <div class="8u"><input type="text" class="text" value="${pendides}" placeholder="XX盆地中的主要构造线" /></div>
							           </div>
							            <br/> <br/> 
							 <img class="picview" src="${pendilocation}" /><br/> 
							           <div class="row half">
							           <div class="2u"><span>图片描述:</span></div>
							           <div class="8u"><input type="text" class="text" value="${pendilocationdes}" placeholder="盆地的位置" /></div>
							           </div>
							            <br/> <br/> 
							       <img class="picview" src="${pendimap}" /><br/> 
							           <div class="row half">
							           <div class="2u"><span>图片描述:</span></div>
							           <div class="8u"><input type="text" class="text" value="${pendimapdes} " placeholder="盆地地质图"/></div>
							           </div>
							           <br/> <br/> 
						 <img class="picview" src="${dashitu}" /><br/> 
							           <div class="row half">
							           <div class="2u"><span>图片描述:</span></div>
							           <div class="8u"><input type="text" class="text" value="${dashitudes} " placeholder="XX盆地地形大势图"/></div>
							           </div>
							        <br/>  <br/> 
						<img class="picview" src="${chanzhuangpic1}" /><br/> 
							           <div class="row half">
							           <div class="2u"><span>图片描述:</span></div>
							           <div class="8u"><input type="text" class="text" value="${chanzhuangpic1des}" placeholder="依据产状图片1" /></div>
							           </div>
							           <br/><br/> 
							 <img class="picview" src="${chanzhuangpic2}" /><br/> 
							          <div class="row half">
							           <div class="2u"><span>图片描述:</span></div>
							           <div class="8u"><input type="text" class="text" value="${chanzhuangpic2des} " placeholder="依据产状图片2"/></div>
							         </div>
							         <br/> <br/> 
							       <img class="picview" src="${zhengdimao}" /><br/> 
							           <div class="row half">
							           <div class="2u"><span>图片描述:</span></div>
							           <div class="8u"><input type="text" class="text" value="${zhengdimaodes}" placeholder="正地貌图片" /></div>
							            </div>
							            <br/> <br/> 
							      <img class="picview" src="${fudimao}" /><br/> 
							           <div class="row half">
							           <div class="2u"><span>图片描述:</span></div>
							           <div class="8u"><input type="text" class="text" value="${fudimaodes}" placeholder="负地貌图片" /></div>
							            </div>
							       <br/>  <br/>
							       <img class="picview" src="${danti}" /><br/> 
							           <div class="row half">
							           <div class="2u"><span>图片描述:</span></div>
							           <div class="8u"><input type="text" class="text" value="${dantides} " placeholder="单体形态图片"/></div>
							            </div>
							          <br/> <br/>
							         <img class="picview" src="${qunti}" /><br/> 
							           <div class="row half">
							           <div class="2u"><span>图片描述:</span></div>
							           <div class="8u"><input type="text" class="text" value="${quntindes} " placeholder="群体形态与发育阶段图片 "/></div>
							            </div>
							         <br/> <br/>
							         <img class="picview" src="${yapo}" /><br/> 
							         <div class="row half">
							           <div class="2u"><span>图片描述:</span></div>
							           <div class="8u"><input type="text" class="text" value="${yapodes} " placeholder="崖坡特点图片"/></div> 
							          </div>
							         <br/><br/>
							         <img class="picview" src="${zonghe}" /><br/> 
							            <div class="row half">
							           <div class="2u"><span>图片描述:</span></div>
							           <div class="8u"><input type="text" class="text" value="${zonghedes} " placeholder="综合景观图片"/></div>
							             </div>
							          <br/> <br/>
							          <img class="picview" src="${dili}" /><br/> 
							            <div class="row half">
							           <div class="2u"><span>图片描述:</span></div>
							           <div class="8u"><input type="text" class="text" value="${dilides}" placeholder="综合自然地理环境图片"/></div>
							           </div>
							        <br/> 
						</div>
					</section>
					...
					<section id="contact5" class="eight">
                        ...
                        <h3 id="flandmark2"></h3>
						<br/> 
                                 <%Integer lSize = (Integer)session.getAttribute("lSize");                           
                             if(lSize == 0){ %>   <h4>暂无上传图片</h4>  <%} %>  
                             <%if(lSize > 0){ %>   
						          <br/>   <img class="picview" src="${biaozhi1}" /><br/>
							         <div class="row half">
							           <div class="2u"><span>图片描述:</span></div>
							           <div class="8u"><input type="text" class="text" value="${biaozhi1des} " placeholder="图片1"/></div><br/>
							        </div>  <%} %>
							 <%if(lSize > 1){ %>   
						          <br/>   <img class="picview" src="${biaozhi2}" /><br/>
							         <div class="row half">
							           <div class="2u"><span>图片描述:</span></div>
							           <div class="8u"><input type="text" class="text" value="${biaozhi2des} " placeholder="图片2"/></div><br/>
							        </div>  <%} %>
							 <%if(lSize > 2){ %>   
						          <br/>   <img class="picview" src="${biaozhi3}" /><br/>
							         <div class="row half">
							           <div class="2u"><span>图片描述:</span></div>
							           <div class="8u"><input type="text" class="text" value="${biaozhi3des} " placeholder="图片3"/></div><br/>
							         </div> <%} %>        
							 <%if(lSize > 3){ %>   
						          <br/>   <img class="picview" src="${biaozhi4}" /><br/>
							         <div class="row half">
							           <div class="2u"><span>图片描述:</span></div>
							           <div class="8u"><input type="text" class="text" value="${biaozhi4des} " placeholder="图片4"/></div><br/>
							        </div> <%} %>        
                             <%if(lSize > 4){ %>   
						          <br/>   <img class="picview" src="${biaozhi5}" /><br/>
							         <div class="row half">
							           <div class="2u"><span>图片描述:</span></div>
							           <div class="8u"><input type="text" class="text" value="${biaozhi5des} " placeholder="图片5"/></div><br/>
							         </div> <%} %>
						</div>
					</section>
					...
					<section id="contact6" class="nine">
						<div class="container">
                         <h3 id="fgeology2"></h3>
							<br/>
							<br/>
							<%Integer gSize = (Integer)session.getAttribute("gSize");                           
                             if(gSize == 0){ %>   <h4>暂无上传图片</h4>  <%} %>  
                             <%if(gSize > 0){ %>   
						          <br/>   <img class="picview" src="${dizhi1}" /><br/>
							         <div class="row half">
							           <div class="2u"><span>图片描述:</span></div>
							           <div class="8u"><input type="text" class="text" value="${dizhi1des} " placeholder="图片1"/></div><br/>
							         </div> <%} %>
							 <%if(gSize > 1){ %>   
						          <br/>   <img class="picview" src="${dizhi2}" /><br/>
							         <div class="row half">
							           <div class="2u"><span>图片描述:</span></div>
							           <div class="8u"><input type="text" class="text" value="${dizhi2des} " placeholder="图片2"/></div><br/>
							        </div>  <%} %>
							 <%if(gSize > 2){ %>   
						          <br/>   <img class="picview" src="${dizhi3}" /><br/>
							         <div class="row half">
							           <div class="2u"><span>图片描述:</span></div>
							           <div class="8u"><input type="text" class="text" value="${dizhi3des} " placeholder="图片3"/></div><br/>
							         </div> <%} %>        
							 <%if(gSize > 3){ %>   
						          <br/>   <img class="picview" src="${dizhi4}" /><br/>
							         <div class="row half">
							           <div class="2u"><span>图片描述:</span></div>
							           <div class="8u"><input type="text" class="text" value="${dizhi4des} " placeholder="图片4"/></div><br/>
							         </div> <%} %>        
                             <%if(gSize > 4){ %>   
						          <br/>   <img class="picview" src="${dizhi5}" /><br/>
							         <div class="row half">
							           <div class="2u"><span>图片描述:</span></div>
							           <div class="8u"><input type="text" class="text" value="${dizhi5des} " placeholder="图片5"/></div><br/>
							        </div> <%} %>
					...
					<section id="contact7" class="ten">
						<div class="container">
                         ...
                         <br/>
                         <br/>
							<%Integer cSize = (Integer)session.getAttribute("cSize");                           
                             if(cSize == 0){ %>   <h4>暂无上传图片</h4>  <%} %>  
                             <%if(cSize > 0){ %>   
						          <br/>   <img class="picview" src="${wenhua1}" /><br/>
							         <div class="row half">
							           <div class="2u"><span>图片描述:</span></div>
							           <div class="8u"><input type="text" class="text" value="${wenhua1des} " placeholder="图片1"/></div><br/>
							        </div>  <%} %>
							 <%if(cSize > 1){ %>   
						          <br/>   <img class="picview" src="${wenhua2}" /><br/>
							         <div class="row half">
							           <div class="2u"><span>图片描述:</span></div>
							           <div class="8u"><input type="text" class="text" value="${wenhua2des} " placeholder="图片2"/></div><br/>
							        </div>  <%} %>
							 <%if(cSize > 2){ %>   
						          <br/>   <img class="picview" src="${wenhua3}" /><br/>
							        <div class="row half">
							           <div class="2u"><span>图片描述:</span></div>
							           <div class="8u"><input type="text" class="text" value="${wenhua3des} " placeholder="图片3"/></div><br/>
							         </div> <%} %>        
							 <%if(cSize > 3){ %>   
						          <br/>   <img class="picview" src="${wenhua4}" /><br/>
							         <div class="row half">
							           <div class="2u"><span>图片描述:</span></div>
							           <div class="8u"><input type="text" class="text" value="${wenhua4des} " placeholder="图片4"/></div><br/>
							        </div>  <%} %>        
                             <%if(cSize > 4){ %>   
						          <br/>   <img class="picview" src="${wenhua5}" /><br/>
							         <div class="row half">
							           <div class="2u"><span>图片描述:</span></div>
							           <div class="8u"><input type="text" class="text" value="${wenhua5des} " placeholder="图片5"/></div><br/>
							         </div>  <%} %>
