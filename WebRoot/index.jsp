...
<body>
	<div class="indexmain">
		<div class="title">
			<div>
				<span style="font-weight:bold">丹霞胜景</span>
		...
		<div class="links">
			<input type="button" class="button01" value="》》中 文 版"
				onclick="window.location.href='Tochinese'" /> 
			<input type="button" class="button01" value="》》English"
				onclick="window.location.href='Toenglish'" />
		</div>
		<div class="helps">
			<h3>建设单位</h3>
